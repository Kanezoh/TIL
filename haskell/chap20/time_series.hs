...
-- 時系列の財務データ
file1 :: [(Int, Double)]
file1 = [(1,200.1), (2,199.5), (3, 199.4), (4,198.9), (5, 199.0), (6, 200.2), (9, 200.3),
         (10,201.2), (12,202.9)]
...
file4 :: [(Int, Double)]
file4 = [(26,219.8), (27,220.5), (28,223.8),(29,222.8),(30,223.8), (31,221.7), (32, 222.3),
         (33,220.8), (34, 219.4), (35,220.1), (36, 220.6)]

-- これらのデータを結合したい→Semigroup
-- 時系列データのリストの結合→Monoid
-- 欠損値の扱い→Maybe型
